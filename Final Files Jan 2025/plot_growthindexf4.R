...
combined_datasetJan2025 <- read_csv("combined_datasetJan2025.csv")

#import dcco and bcnh nestcounts 
dcco_nestcount <- read_csv("C:/Users/baill/OneDrive/r-projects/cormorant-colony-analysis/current working files/working files for GitHub/test_thesis_repo/Final Files Jan 2025/dcco_data.csv")
bcnh_nestcount <- read_csv("C:/Users/baill/OneDrive/r-projects/cormorant-colony-analysis/current working files/working files for GitHub/test_thesis_repo/Final Files Jan 2025/bcnh_data.csv")

dcco_data <- combined_datasetJan2025 %>% 
  select(year, dcco_growthindex) %>%
  rename(growth_index = dcco_growthindex)

bcnh_data <- combined_datasetJan2025 %>% 
...
#save as png
#ggsave("C:/Users/baill/OneDrive/r-projects/cormorant-colony-analysis/current working files/working files for GitHub/test_thesis_repo/Final Files Jan 2025/f6.growthindexplotMarch2025.png", width = 8, height = 6, dpi = 600)
...
#ggsave("C:/Users/baill/OneDrive/r-projects/cormorant-colony-analysis/current working files/working files for GitHub/test_thesis_repo/Final Files Jan 2025/f4.nestcountplotMarch2025.png", width = 8, height = 6, dpi = 600)